...
set :application, "vue1.wondercv.com"
#set :application, "yuan_bian_cheng_h5"
set :repository, "./dist"
set :scm, :none
# Or: `accurev`, `bzr`, `cvs`, `darcs`, `git`, `mercurial`, `perforce`, `subversion` or `none`
set :deploy_via, :copy
#测试服务器
ssh_options[:port] = 33666
server = "39.96.184.103"
#正式服务器
#server = "101.201.118.226"
...
set :deploy_to, "/opt/app/vue1.wondercv.com"
#set :deploy_to, "/opt/app/yuan_bian_cheng_h5"
